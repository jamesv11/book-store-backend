using Aplicacion.Services.Mapping;
using AutoMapper;
using Dominio.Contract;
using Infraestructura;
using Infraestructura.Base;
using Infraestructura.Initialization;
...
namespace book_store_backend
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                m.AddProfile(new BookMapping());
                m.AddProfile(new UserMapping());
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "book_store_backend v1"));
            }
            else
            {
